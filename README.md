...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Love-harry/Rose-Bot)<br>
...
class Development(Config):
    OWNER_ID = 1707757937  # my telegram ID
    OWNER_USERNAME = "plencoin_official"  # my telegram username
    API_KEY = "5314993782:AAH_hbj6DFF0SFDLE-Ka2tuJL-Xe8htXQKc"  # my api key, as provided by the botfather
    SQLALCHEMY_DATABASE_URI = 'postgresql://username:password@localhost:5432/database'  # sample db credentials
    MESSAGE_DUMP = '-1234567890' # some group chat that your bot is a member of
    USE_MESSAGE_DUMP = True
    SUDO_USERS = [1707757937]  # List of id's for users which have sudo access to the bot.
    LOAD = []
    NO_LOAD = ['translation']
```
...
The following env variables are supported:
 ...
 - `TOKEN`: 5314993782:AAH_hbj6DFF0SFDLE-Ka2tuJL-Xe8htXQKc
 - `OWNER_ID`: 1707757937
 - `OWNER_USERNAME`: @plencoin_official
